...
buttons = [
    ...
    [Button((40, 0, 480, 80), bg='box'),
     Button((40, 100, 80, 80), bg='1', cb=numericCallback, value=1),
     Button((120, 100, 80, 80), bg='2', cb=numericCallback, value=2),
     Button((200, 100, 80, 80), bg='3', cb=numericCallback, value=3),
     Button((40, 150, 80, 80), bg='4', cb=numericCallback, value=4),
     Button((120, 150, 80, 80), bg='5', cb=numericCallback, value=5),
     Button((200, 150, 80, 80), bg='6', cb=numericCallback, value=6),
     Button((40, 200, 80, 80), bg='7', cb=numericCallback, value=7),
     Button((120, 200, 80, 80), bg='8', cb=numericCallback, value=8),
     Button((200, 200, 80, 80), bg='9', cb=numericCallback, value=9),
