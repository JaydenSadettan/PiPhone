...
buttons = [
    ...
    # Alphabet Screen 4.
    [Button((20, 100, 40, 40), bg='A', cb=numericCallback, value="a"),
     Button((60, 100, 40, 40), bg='B', cb=numericCallback, value="b"),
     Button((100, 100, 40, 40), bg='C', cb=numericCallback, value="c"),
     Button((140, 100, 40, 40), bg='D', cb=numericCallback, value="d"),
     Button((180, 100, 40, 40), bg='E', cb=numericCallback, value="e"),
     Button((220, 100, 40, 40), bg='F', cb=numericCallback, value="f"),
     Button((260, 100, 40, 40), bg='G', cb=numericCallback, value="g"),
     Button((300, 100, 40, 40), bg='H', cb=numericCallback, value="h"),
     Button((20, 200, 40, 40), bg='I', cb=numericCallback, value="i"),
     Button((60, 200, 40, 40), bg='J', cb=numericCallback, value="j"),
     Button((100, 200, 40, 40), bg='K', cb=numericCallback, value="k"),
     Button((140, 200, 40, 40), bg='L', cb=numericCallback, value="l"),
     Button((180, 200, 40, 40), bg='M', cb=numericCallback, value="m"),
     Button((220, 200, 40, 40), bg='N', cb=numericCallback, value="n"),
     Button((260, 200, 40, 40), bg='O', cb=numericCallback, value="o"),
     Button((300, 200, 40, 40), bg='P', cb=numericCallback, value="p"),
     Button((20, 300, 40, 40), bg='Q', cb=numericCallback, value="q"),
     Button((60, 300, 40, 40), bg='R', cb=numericCallback, value="r"),
     Button((100, 300, 40, 40), bg='S', cb=numericCallback, value="s"),
     Button((140, 300, 40, 40), bg='T', cb=numericCallback, value="t"),
     Button((180, 300, 40, 40), bg='U', cb=numericCallback, value="u"),
     Button((220, 300, 40, 40), bg='V', cb=numericCallback, value="v"),
     Button((260, 300, 40, 40), bg='W', cb=numericCallback, value="w"),
     Button((300, 300, 40, 40), bg='X', cb=numericCallback, value="x"),
     Button((60, 400, 40, 40), bg='start', cb=numericCallback, value=1),
     Button((140, 400, 40, 40), bg='Y', cb=numericCallback, value="y"),
     Button((180, 400, 40, 40), bg='Z', cb=numericCallback, value="z"),
     Button((260, 400, 40, 40), bg='stop', cb=numericCallback, value=0),
