...
buttons = [
    ...
    [Button((50, 80, 80, 80), bg='1', cb=numericCallback, value="Hi"),
     ...
     Button((210, 400, 80, 80), bg='del2', cb=numericCallback, value=10)],
    # Alphabet
    [Button((20, 20, 20, 20), bg='A', cb=numericCallback, value="Hi"),
     Button((50, 20, 20, 20), bg='B', cb=numericCallback, value="Take Care"),
     Button((80, 20, 20, 20), bg='C', cb=numericCallback, value="Thank you"),
     Button((110, 20, 20, 20), bg='D', cb=numericCallback, value="Yes"),
     Button((140, 20, 20, 20), bg='E', cb=numericCallback, value="No"),
     Button((170, 20, 20, 20), bg='F', cb=numericCallback, value="I don't know"),
     Button((200, 20, 20, 20), bg='G', cb=numericCallback, value="."),
     Button((230, 20, 20, 20), bg='H', cb=numericCallback, value=","),
     Button((20, 100, 20, 20), bg='I', cb=numericCallback, value="Hi"),
     Button((50, 100, 20, 20), bg='J', cb=numericCallback, value="Take Care"),
     Button((80, 100, 20, 20), bg='K', cb=numericCallback, value="Thank you"),
     Button((110, 100, 20, 20), bg='L', cb=numericCallback, value="Yes"),
     Button((140, 100, 20, 20), bg='M', cb=numericCallback, value="No"),
     Button((170, 100, 20, 20), bg='N', cb=numericCallback, value="I don't know"),
     Button((200, 100, 20, 20), bg='O', cb=numericCallback, value="."),
     Button((230, 100, 20, 20), bg='P', cb=numericCallback, value=","),
     Button((20, 180, 20, 20), bg='Q', cb=numericCallback, value="Hi"),
     Button((50, 180, 20, 20), bg='R', cb=numericCallback, value="Take Care"),
     Button((80, 180, 20, 20), bg='S', cb=numericCallback, value="Thank you"),
     Button((110, 180, 20, 20), bg='T', cb=numericCallback, value="Yes"),
     Button((140, 180, 20, 20), bg='U', cb=numericCallback, value="No"),
     Button((170, 180, 20, 20), bg='V', cb=numericCallback, value="I don't know"),
     Button((200, 180, 20, 20), bg='W', cb=numericCallback, value="."),
     Button((230, 180, 20, 20), bg='X', cb=numericCallback, value=","),
     Button((110, 260, 20, 20), bg='Y', cb=numericCallback, value="Yes"),
     Button((140, 260, 20, 20), bg='Z', cb=numericCallback, value="No")
     ]
